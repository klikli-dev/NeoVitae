...
public class BookLivingDowngradeRecipePage extends BookRecipePage<LivingDowngradeRecipe> {
    ...
    public BookLivingDowngradeRecipePage(BookTextHolder title1, ResourceLocation recipeId1,
    ...
    public static BookLivingDowngradeRecipePage fromJson(JsonObject json, HolderLookup.Provider provider) {
        ...
        return new BookLivingDowngradeRecipePage(common.title1(), common.recipeId1(),
    ...
    @Override
    protected ItemStack getRecipeOutput(Level level, RecipeHolder<LivingDowngradeRecipe> recipeHolder) {
