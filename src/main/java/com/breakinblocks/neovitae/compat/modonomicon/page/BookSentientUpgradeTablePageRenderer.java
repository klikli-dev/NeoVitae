...
public class BookSentientUpgradeTablePageRenderer extends BookPageRenderer<BookSentientUpgradeTablePage> {

    public BookSentientUpgradeTablePageRenderer(BookSentientUpgradeTablePage page) {
        super(page);
    }
