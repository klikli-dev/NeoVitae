...
public class BookSentientDowngradeRecipePage extends BookRecipePage<SentientDowngradeRecipe> {
    ...
    public static BookSentientDowngradeRecipePage fromJson(JsonObject json, HolderLookup.Provider provider) {
        ...
        return new BookSentientDowngradeRecipePage(common.title1(), common.recipeId1(),
    ...
    @Override
    protected ItemStack getRecipeOutput(Level level, RecipeHolder<SentientDowngradeRecipe> recipeHolder) {
