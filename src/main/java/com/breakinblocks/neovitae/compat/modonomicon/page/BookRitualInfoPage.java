...
public class BookRitualInfoPage extends BookPage {
    ...
    public BookRitualInfoPage(BookTextHolder title, BookTextHolder text, String anchor, BookCondition condition) {
    ...
    public static BookRitualInfoPage fromNetwork(RegistryFriendlyByteBuf buffer) {
