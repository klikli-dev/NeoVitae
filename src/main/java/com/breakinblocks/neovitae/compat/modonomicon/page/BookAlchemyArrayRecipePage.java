...
public class BookAlchemyArrayRecipePage extends BookRecipePage<AlchemyArrayRecipe> {
    ...
    public BookAlchemyArrayRecipePage(BookTextHolder title1, ResourceLocation recipeId1,
                                      BookTextHolder title2, ResourceLocation recipeId2,
                                      BookTextHolder text, String anchor, BookCondition condition) {
        super(NVRecipes.ALCHEMY_ARRAY_TYPE.get(), title1, recipeId1, title2, recipeId2, text, anchor, condition);
    }

    public static BookAlchemyArrayRecipePage fromJson(JsonObject json, HolderLookup.Provider provider) {
        ...
        return new BookAlchemyArrayRecipePage(common.title1(), common.recipeId1(),
    ...
    @Override
    protected ItemStack getRecipeOutput(Level level, RecipeHolder<AlchemyArrayRecipe> recipeHolder) {
