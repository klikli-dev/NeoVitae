...
/**
 * Events related to Sentient Armor upgrades.
 */
public abstract class SentientArmorEvent extends Event {
    private final Player wearer;
    private final ItemStack armorPiece;

    protected SentientArmorEvent(Player wearer, ItemStack armorPiece) {
        this.wearer = wearer;
        this.armorPiece = armorPiece;
    }

    /**
     * Gets the player wearing the Sentient Armor.
     */
    ...
    /**
     * Gets the Sentient Armor chest piece.
     */
     ...
     */
    public static class ExperienceGain extends SentientArmorEvent implements ICancellableEvent {
     ...
     */
    public static class LevelUp extends SentientArmorEvent {
        private final ResourceLocation upgradeId;
