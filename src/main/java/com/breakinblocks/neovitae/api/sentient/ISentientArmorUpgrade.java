...
/**
 * Interface representing a Sentient Armor upgrade.
 * Sentient Armor upgrades are enhancements applied to the Sentient Armor chest piece
 ...
 */
public interface ISentientArmorUpgrade {
