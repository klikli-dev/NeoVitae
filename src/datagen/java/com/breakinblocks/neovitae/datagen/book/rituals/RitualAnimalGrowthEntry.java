...
public class RitualAnimalGrowthEntry extends EntryProvider {
    ...
    protected void generatePages() {
        ...
        this.pageText("- [#](8B0000)Raw Spiritus[#](): Further accelerates the growth of young creatures."
                + "\n\n- [#](8B0000)Spiritus Vindicta[#](): Compels adult animals to breed without intervention."
                + "\n\n- [#](8B0000)Spiritus Nihilum[#](): Increases the frequency of growth pulses."
                + "\n\n- [#](8B0000)Spiritus Invictus[#](): Collects products from sheared or milked animals into a nearby chest.");
    }
