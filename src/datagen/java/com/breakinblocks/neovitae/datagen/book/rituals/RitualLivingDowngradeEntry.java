...
public class RitualLivingDowngradeEntry extends EntryProvider {
    ...
    protected void generatePages() {
        ...
        this.pageText("This ritual consumes [#](8B0000)Upgrade Points[#]() (from [#](8B0000)Tomes[#](), [#](8B0000)Scraps[#](), or [#](8B0000)Synthetic Points[#]()) alongside a specific [#](8B0000)Key Item[#]() per level, inscribing [#](4A0080)Downgrades[#]() into your worn [#](8B0000)Living Armor[#](). Each downgrade demands a different key item.");
        ...
        this.page("usage", () -> BookTextPageModel.create()
                .withText(this.context().pageText()));
        this.pageText("Place your point sources and the required key items into the linked chest while wearing your [#](8B0000)Living Armor[#](). The ritual consumes them in order: [#](8B0000)Upgrade Scraps[#]() first, then [#](8B0000)Upgrade Tomes[#](), and finally [#](8B0000)Synthetic Points[#]().");
