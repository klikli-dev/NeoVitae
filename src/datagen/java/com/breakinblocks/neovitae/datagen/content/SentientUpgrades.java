...
public class SentientUpgrades {
    ...
    public static void bootstrap(BootstrapContext<SentientUpgrade> context) {
        context.register(
                ...
                new SentientUpgrade.Builder()
                        ...
                        .level(4, -40)
                        .level(5, -50)
                        .withEffect(SentientEffectComponents.TICK.get(), new CooldownEffect(BATTLE_HUNGRY.location()))
                        .withEffect(SentientEffectComponents.TICK.get(), new ResetCooldownEffect(BATTLE_HUNGRY.location(), LevelBasedValue.constant(20), Optional.of(new CauseExhaustionEffect(LevelBasedValue.lookup(List.of(0.02F, 0.04F, 0.06F, 0.08F, 0.1F), LevelBasedValue.constant(0))))), cooldownCondition(BATTLE_HUNGRY))
                        .withEffect(SentientEffectComponents.DEALING_DAMAGE.get(), new DelegateEffect(new ResetCooldownEffect(BATTLE_HUNGRY.location(), LevelBasedValue.lookup(List.of(600f, 600f, 600f, 500f, 400f), LevelBasedValue.constant(300)), Optional.empty())))
                        .build()
        );
        context.register(
                CRIPPLED_ARM,
        ...
        context.register(
                ...
                new SentientUpgrade.Builder()
                        ...
                        .level(9, -160)
                        .level(10, -200)
                        .withEffect(SentientEffectComponents.ATTRIBUTES.get(), new AttributeEffect(DIG_SLOWDOWN.location(), Attributes.BLOCK_BREAK_SPEED, Operation.ADD_MULTIPLIED_BASE, LevelBasedValue.lookup(List.of(-0.1f, -0.2f, -0.3f, -0.4f, -0.45f, -0.5f, -0.6f, -0.65f, -0.7f, -0.8f), LevelBasedValue.constant(-0.8f))))
                        .build()
        );
        context.register(
                MELEE_DECREASE,
        ...
        context.register(
                ...
                new SentientUpgrade.Builder()
                        ...
                        .level(9, -160)
                        .level(10, -200)
                        .withEffect(SentientEffectComponents.ATTRIBUTES.get(), new AttributeEffect(SPEED_DECREASE.location(), Attributes.MOVEMENT_SPEED, Operation.ADD_MULTIPLIED_BASE, LevelBasedValue.lookup(List.of(-0.1f, -0.2f, -0.3f, -0.4f, -0.45f, -0.5f, -0.6f, -0.65f, -0.7f, -0.8f), LevelBasedValue.constant(-0.8f))))
                        .build()
        );
        context.register(
                STORM_TROOPER,
        ...
        context.register(
                ...
                new SentientUpgrade.Builder()
                        ...
                        .level(9, -160)
                        .level(10, -200)
                        .withEffect(SentientEffectComponents.ATTRIBUTES.get(), new AttributeEffect(SWIM_DECREASE.location(), NeoForgeMod.SWIM_SPEED, Operation.ADD_MULTIPLIED_BASE, LevelBasedValue.lookup(List.of(-0.1f, -0.2f, -0.25f, -0.3f, -0.35f, -0.4f,  -0.5f, -0.6f, -0.7f, -0.8f), LevelBasedValue.constant(-0.9f))))
                        .build()
        );
        ...
        context.register(
                ...
                new SentientUpgrade.Builder()
                        ...
                        .level(80000, 240)
                        .level(150000, 300)
                        .withEffect(SentientEffectComponents.ATTRIBUTES.get(), new AttributeEffect(DIGGING.location(), Attributes.MINING_EFFICIENCY, Operation.ADD_MULTIPLIED_BASE, LevelBasedValue.lookup(List.of(0.1f, 0.2f, 0.3f, 0.4f, 0.5f, 0.6f, 0.7f, 0.8f, 1f, 1.2f, 1.5f), LevelBasedValue.constant(0f))))
                        .withEffect(SentientEffectComponents.BREAK_BLOCK.get(), new AddMobEffect(MobEffects.DIG_SPEED, LevelBasedValue.lookup(List.of(0f, 0f, 0f, 1f, 1f, 1f, 1f, 1f, 2f, 2f), LevelBasedValue.constant(0)), LevelBasedValue.lookup(List.of(0f, 50f, 60f, 100f, 100f, 100f, 100f, 150f, 150f, 150f), LevelBasedValue.constant(0))))
                        .build()
        );
        context.register(
                ELYTRA,
        ...
        context.register(
                ...
                new SentientUpgrade.Builder()
                        ...
                        .level(24000, 25)
                        .level(30000, 40)
                        .withEffect(SentientEffectComponents.TICK.get(), new CooldownEffect(FIRE_RESIST.location()))
                        .withEffect(SentientEffectComponents.TICK.get(), new ResetCooldownEffect(FIRE_RESIST.location(), LevelBasedValue.lookup(List.of(6000f, 4800f, 4800f, 3600f, 2400f), LevelBasedValue.constant(6000)), Optional.of(new AddMobEffect(MobEffects.FIRE_RESISTANCE, LevelBasedValue.constant(0f), LevelBasedValue.lookup(List.of(600f, 600f, 800f, 1000f, 1200f), LevelBasedValue.constant(0))))), AllOfCondition.allOf(cooldownCondition(FIRE_RESIST), LootItemEntityPropertyCondition.hasProperties(LootContext.EntityTarget.THIS, new EntityPredicate.Builder().flags(new EntityFlagsPredicate.Builder().setOnFire(true)))))
                        .build()
        );
        context.register(
                GILDED,
        ...
        context.register(
                ...
                new SentientUpgrade.Builder()
                        ...
                        .level(7600, 215)
                        .level(10000, 320)
                        .withEffect(SentientEffectComponents.ATTRIBUTES.get(), new AttributeEffect(HEALTH.location(), Attributes.MAX_HEALTH, Operation.ADD_VALUE, LevelBasedValue.lookup(List.of(4f, 8f, 12f, 16f, 20f, 26f, 32f, 38f, 44f, 50f), LevelBasedValue.constant(0f))))
                        .build()
        );
        context.register(
                JUMP,
                new SentientUpgrade.Builder()
                        ...
                        .level(3600, 140)
                        .level(5000, 200)
                        .withEffect(SentientEffectComponents.ATTRIBUTES.get(), new AttributeEffect(JUMP.location(), Attributes.JUMP_STRENGTH, Operation.ADD_MULTIPLIED_BASE, LevelBasedValue.lookup(List.of(0.1f, 0.2f, 0.3f, 0.4f, 0.5f, 0.7f, 0.75f, 0.9f, 1.1f, 1.3f), LevelBasedValue.constant(0f))))
                        .withEffect(SentientEffectComponents.ATTRIBUTES.get(), new AttributeEffect(JUMP.location(), Attributes.FALL_DAMAGE_MULTIPLIER, Operation.ADD_MULTIPLIED_BASE, LevelBasedValue.lookup(List.of(-0.33f, -0.4f, -0.45f, -0.5f, -0.55f, -0.6f, -0.65f, -0.75f, -0.85f, -0.95f), LevelBasedValue.constant(0f))))
                        .build()
        );
        context.register(
                KNOCKBACK_RESIST,
                new SentientUpgrade.Builder()
                        ...
                        .level(500, 26)
                        .level(1000, 42)
                        .withEffect(SentientEffectComponents.ATTRIBUTES.get(), new AttributeEffect(KNOCKBACK_RESIST.location(), Attributes.MAX_HEALTH, Operation.ADD_VALUE, LevelBasedValue.lookup(List.of(0f, 0f, 0f, 4f, 10f), LevelBasedValue.constant(0f))))
                        .withEffect(SentientEffectComponents.ATTRIBUTES.get(), new AttributeEffect(KNOCKBACK_RESIST.location(), Attributes.KNOCKBACK_RESISTANCE, Operation.ADD_VALUE, LevelBasedValue.lookup(List.of(0.2f, 0.4f, 0.6f, 0.8f, 1f), LevelBasedValue.constant(0f))))
                        .build()
        );
        context.register(
                MELEE_DAMAGE,
                new SentientUpgrade.Builder()
                        ...
                        .level(11500, 215)
                        .level(14000, 320)
                        .withEffect(SentientEffectComponents.ATTRIBUTES.get(), new AttributeEffect(MELEE_DAMAGE.location(), Attributes.ATTACK_DAMAGE, Operation.ADD_VALUE, LevelBasedValue.lookup(List.of(0.5f, 1f, 1.5f, 2f, 2.5f, 3f, 4f, 5f, 6f, 7f), LevelBasedValue.constant(0f))))
                        .build()
        );
        ...
        context.register(
                ...
                new SentientUpgrade.Builder()
                        ...
                        .level(24000, 25)
                        .level(30000, 40)
                        .withEffect(SentientEffectComponents.TICK.get(), new CooldownEffect(POISON_RESIST.location()))
        ...
        context.register(
                ...
                new SentientUpgrade.Builder()
                        ...
                        .withEffect(SentientEffectComponents.TICK.get(), new CooldownEffect(REPAIR.location()))
                        .withEffect(SentientEffectComponents.TICK.get(), new ResetCooldownEffect(REPAIR.location(), LevelBasedValue.constant(100), Optional.of(new RandomArmourDamageEffect(LevelBasedValue.constant(-2)))), cooldownCondition(REPAIR))
                        .build()
        );
        context.register(
                SELF_SACRIFICE,
                new SentientUpgrade.Builder()
                        ...
                        .level(3600, 250)
                        .level(5000, 350)
                        .withEffect(SentientEffectComponents.ATTRIBUTES.get(), new AttributeEffect(SELF_SACRIFICE.location(), NVAttributes.SELF_SACRIFICE_MULTIPLIER.getDelegate(), Operation.ADD_MULTIPLIED_BASE, LevelBasedValue.lookup(List.of(0.15f, 0.3f, 0.45f, 0.6f, 0.75f, 0.9f, 1.05f, 1.2f, 1.35f, 1.5f), LevelBasedValue.constant(0f))))
                        .build()
        );
        context.register(
                SPEED,
                new SentientUpgrade.Builder()
                        ...
                        .level(50000, 180)
                        .level(70000, 250)
                        .withEffect(SentientEffectComponents.ATTRIBUTES.get(), new AttributeEffect(SPEED.location(), Attributes.MOVEMENT_SPEED, Operation.ADD_MULTIPLIED_BASE, LevelBasedValue.lookup(List.of(0.1f, 0.2f, 0.3f, 0.4f, 0.5f, 0.6f, 0.7f, 0.9f, 1.1f, 1.3f, 1.5f), LevelBasedValue.constant(0f))))
                        .withEffect(SentientEffectComponents.TICK.get(), new AddMobEffect(MobEffects.MOVEMENT_SPEED, LevelBasedValue.lookup(List.of(0f, 0f, 0f, 0f, 0f, 0f, 0f, 1f, 1f, 2f), LevelBasedValue.constant(0)), LevelBasedValue.lookup(List.of(0f, 0f, 0f, 0f, 0f, 20f, 60f, 60f, 100f, 200f), LevelBasedValue.constant(0))), LootItemEntityPropertyCondition.hasProperties(LootContext.EntityTarget.THIS, new EntityPredicate.Builder().flags(new EntityFlagsPredicate.Builder().setSprinting(true))))
                        .build()
        );
        context.register(
                SPRINT_ATTACK,
        ...
        context.register(
                ...
                new SentientUpgrade.Builder()
                        ...
                        .level(4, 65)
                        .level(5, 90)
                        .withEffect(SentientEffectComponents.ATTRIBUTES.get(), new AttributeEffect(LUCK.location(), Attributes.LUCK, Operation.ADD_VALUE, LevelBasedValue.lookup(List.of(2f, 4f, 6f, 8f, 10f), LevelBasedValue.constant(0f))))
                        .build()
        );
    ...
    private static ResourceKey<SentientUpgrade> exp(ResourceKey<SentientUpgrade> key) {
        ResourceKey<SentientUpgrade> xpKey = ResourceKey.create(key.registryKey(), key.location().withPrefix("exp/"));
        expList.add(xpKey);
        return xpKey;
    }
    ...
    public static void tags(Function<TagKey<SentientUpgrade>, TagsProvider.TagAppender<SentientUpgrade>> adder) {
    ...
    private static ResourceKey<SentientUpgrade> key(String path) {
        return ResourceKey.create(NVRegistries.Keys.SENTIENT_UPGRADES, ResourceLocation.fromNamespaceAndPath(NeoVitae.MODID, path));
    }
}
